...
foreach ($employees as $employee) {
	echo $employee->afficherEmployé();

	$augmentation = rand(10, 200);
	echo "On augmente le salaire de " . $augmentation . " €, ";
	$employee->augmentationDuSalaire($augmentation);
	echo "son nouveau salaire est de " . $employee->getSalaire() . " € <br>";
